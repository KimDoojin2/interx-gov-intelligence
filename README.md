...
| **📄 공고 상세** | BD 상세 분석 | 5대 스코어 카드 + BD 인텔리전스 + 솔루션 매칭 바 + 키워드 태그 + AI 분석 |
| **🚀 수집 실행** | 파이프라인 실행 | 버튼 하나로 19개 사이트 수집 → 실시간 프로그레스 |
| **📋 공고 목록** | 전체 공고 조회 | 등급/사이트/키워드 필터 + 공고 상세 보기 + CSV/Excel 다운로드 |
| **🔍 공고 비교** | 공고 비교 | 다중 공고 비교 분석 |
| **🎯 수주 예측** | 수주 확률 | 공고별 수주 확률 분포 히스토그램 + 유망 TOP10 |
| **📅 마감 캘린더** | 마감 관리 | D-3/D-7/D-30 KPI + 타임라인 차트 + 긴급 리스트 |
| **📈 분석** | 종합 분석 | 키워드 트렌드 + 솔루션 매칭 + 시장 동향 |
| **🔬 파싱 검증** | 품질 검증 | 사이트별 파싱 필드 완성도 검증 |
| **🤖 AI 뉴스** | AI 뉴스 | AI/제조 관련 뉴스 피드 |
| **💬 AI 챗봇** | AI 챗봇 | Gemini 기반 공고 분석 챗봇 |
